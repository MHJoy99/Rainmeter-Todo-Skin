...
internal static partial class CalendarApp
{
    ...
    private static string LocalSecretPath { get { return Path.Combine(R,"caldav.secret"); } }
    private static string SecretPath { get { return File.Exists(LocalSecretPath) ? LocalSecretPath : Path.Combine(TodoDir,"caldav.secret"); } }
